//
//  IMAnimationMenuViewController.h
...
@interface IMAnimationMenuViewController : UIViewController <IMMenuProtocol, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate>
